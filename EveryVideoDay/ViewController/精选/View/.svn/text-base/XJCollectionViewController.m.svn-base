...
@interface XJCollectionViewController () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    // 创建有所的cell
    if (self.flag == true){
        XJItemModelDic * dataModel = self.dataDic.secItemListArr[self.index];//找到对应的数组, 然后取值
        self.flag = false;
